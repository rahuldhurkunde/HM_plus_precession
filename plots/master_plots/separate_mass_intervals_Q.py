...
minq_list = [2.0666666, 5.0, 10.0, 15.0]
...
fig.text(0.04, 0.5, '$\chi_{P}$', va='center', rotation='vertical', fontsize=12)
...
plt.savefig('background_adjusted_SRF_diffQ.jpg', dpi=600)
plt.show()	
